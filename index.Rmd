...
use-biblatex: true
bib-latex-options: "style=authoryear, sorting=nyt, backend=biber, maxcitenames=1, firstinits=true, maxbibnames=10, date=year, useprefix, doi=true, isbn=false, uniquename=false, url=false" #for science, you might want style=numeric-comp, sorting=none for numerical in-text citation with references in order of appearance
...
output:
  ...
  bookdown::bs4_book: 
    ...
    theme:
      primary: "#6D1919"
    repo: https://github.com/siobhon-egan/oxforddown-murdoch
    pandoc_args: "--lua-filter=scripts_and_filters/colour_and_highlight.lua"
  bookdown::gitbook:
