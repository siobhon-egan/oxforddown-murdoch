...
%
% Modified by Siobhon Egan (siobhon.egan@murdoch.edu.au), 2021
%
...
\usepackage[style=authoryear, sorting=nyt, backend=biber, maxcitenames=1, firstinits=true, maxbibnames=10, date=year, useprefix, doi=true, isbn=false, uniquename=false, url=false]{biblatex}
...
Modified template for Murdoch University}
\author{Siobhon Egan}
\qual{Bachelor of Science}
...
%
\def\crest{{\includegraphics{templates/mulogo.png}}}
...
\addcontentsline{toc}{section}{Thesis layout}
...
\addcontentsline{toc}{section}{State of contributions}
...
\addcontentsline{toc}{section}{Further details}
